...
export default function Employeecategory(props) {
  ...
  const Action = (cell, row, rowIndex, formatExtraData) => {
    return (
      <span className="action d-flex">
        {current_user?.permissions?.includes("delete_employee_cateory") && (
          <IconButton
        ...
        {current_user?.permissions?.includes("change_employee_cateory") && (
          <IconButton
  ...
  return (
    <div className="p-3">
      <div className="card">
        {current_user?.permissions?.includes("add_employee_cateory") && (
        ...
        {current_user?.permissions?.includes("view_employee_cateory") && (
