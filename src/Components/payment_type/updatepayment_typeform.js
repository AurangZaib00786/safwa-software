...
function Payment_typeUpdate({show,onHide,data,user,route,fun,callback}) {
   ...
   const {t} = useTranslation()
    ...
    const handleSubmit=async(e)=>{
        ...
        const response= await fetch(`${route}/api/payment-types/${data.id}/`,{
            method: "PATCH",
            headers: { 
...
export default Payment_typeUpdate
