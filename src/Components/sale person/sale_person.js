...
import Salepersonform from "./sale_personform";
import Salepersonformupdate from "./updatesale_personform";
...
export default function Saleperson(props) {
    ...
    return (
      <span className="action d-flex">
        <IconButton
          ...
          onClick={() => {
            setrow_id(row.id);
            seturl_to_delete(`${route}/api/sales-persons/${row.id}/`);
            setdelete_user(true);
          }}
        >
  ...
  const download = () => {
    ...
    pdfMake.createPdf(documentDefinition).download("Sale Person.pdf");
  };
