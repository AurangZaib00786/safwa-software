...
import Storeformupdate from "./updatestoreform";
  ...
  const Action = (cell, row, rowIndex, formatExtraData) => {
    return (
      <span className="action d-flex">
        {current_user?.permissions?.includes("delete_store") && (
          <IconButton
        ...
        {current_user?.permissions?.includes("change_store") && (
          <IconButton
      ...
      <div className="card">
        <div className="card-header bg-white  d-flex justify-content-between ">
          ...
          <div className="mt-2 me-2 d-flex">
            ...
            {current_user?.permissions?.includes("add_store") && (
              <Button
                type="button"
                className="mb-2"
        ...
        {current_user?.permissions?.includes("view_store") && (
